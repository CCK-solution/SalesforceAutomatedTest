...
//function to generate faker user data
...
//function to generate an array of fake data
...
export const exportToJson = (data: UserData[], fileName: string) => {
    ...
    console.log(`Data export to JSON file, ${testdataDir}\\${fileName}`);
}
...
export const exportToCsv = (data: UserData[], fileName: string) => {
    ...
    csvWriter.writeRecords(data).then(() => {
        console.log(`Data exportd to CSV file: ${testdataDir}\\${fileName}`);
    });
}
